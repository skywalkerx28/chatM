...
class ChatViewModel: ObservableObject, BitchatDelegate {
    ...
    private let nicknameKey = "chatM.nickname"
    ...
    init() {
        ...
        NotificationCenter.default.addObserver(
            ...
            name: Notification.Name("chatM.retryMessage"),
            object: nil
        )
    ...
    func panicClearAllData() {
        ...
        userDefaults.removeObject(forKey: "chatM.noiseIdentityKey")
        userDefaults.removeObject(forKey: "chatM.messageRetentionKey")
    ...
    func getSenderColor(for message: BitchatMessage, colorScheme: ColorScheme) -> Color {
        ...
        let primaryColor = isDark ? Color.primaryRed : Color.primaryRed
