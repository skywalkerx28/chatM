...
extension Color {
    // Alias to app-wide primary red defined in AuthView
    static var primaryRed: Color { Color.primaryred }
}
...
struct ContentView: View {
    ...
    private var mainHeaderView: some View {
        HStack(spacing: 0) {
            // Back arrow to return to HomeView
            ...
            HStack(spacing: 4) {
                ...
                .foregroundColor(isNostrOnly ? Color.purple : (meshPeerCount > 0 ? textColor : Color.primaryred))
            }
            .onTapGesture {
                withAnimation(.easeInOut(duration: 0.2)) {
                    showSidebar.toggle()
