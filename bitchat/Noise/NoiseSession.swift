...
class NoiseSession {
    ...
    // Thread safety
    private let sessionQueue = DispatchQueue(label: "chat.chatm.noise.session", attributes: .concurrent)
...
class NoiseSessionManager {
    ...
    private let localStaticKey: Curve25519.KeyAgreement.PrivateKey
    private let managerQueue = DispatchQueue(label: "chat.chatm.noise.manager", attributes: .concurrent)
